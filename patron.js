        ...
        card.innerHTML = `
            ...
            <div class="flex justify-between items-start gap-2 mb-2">
                <div class="flex items-center gap-3 min-w-0">
                    <div class="w-12 h-12 rounded-full bg-gradient-to-br ${avatarColor} flex items-center justify-center text-white font-black text-xl shadow-lg shrink-0 border border-white/10">${teacher.full_name ? teacher.full_name.charAt(0).toUpperCase() : '?'}</div>
                    <div class="min-w-0">
                        <h4 class="font-black text-white text-base leading-tight truncate">${teacher.full_name || 'İsimsiz'}</h4>
                        <p class="text-[10px] text-indigo-400 font-bold truncate lowercase mt-0.5">${teacher.email || 'Mail Yok'}</p>
